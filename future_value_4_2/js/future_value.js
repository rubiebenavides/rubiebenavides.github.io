...
if (isNaN(investment) || investment <= 0 || investment > 100000) {
    errorMessage = "Investment must be a number greater than or equal to 100,000";
    $("#investment").focus();
    
}
else if (isNaN(rate) || rate <= 0 || rate > 15) {
    errorMessage = "Rate must be a number greater than or equal to 15";
    $("#rate").focus();

}
else if (isNaN(year) || years <= 0 || years > 50) {
